...
# 🧠 Grafo de Conhecimento Científico — Visão Geral

Central do ecossistema de conhecimento científico sobre bioinformática, scRNA-seq, redes de memória associativa Hopfield e redução vetorial rSWeeP. Este arquivo orienta a navegação humana e serve de mapa de navegação fluida para assistentes de IA.

---

## 🗺️ Mapeamento do Grafo (PARA)

Cada seção do sistema possui seu arquivo `index.md` interno para consulta rápida:

* 📥 **[[00_Caixa-de-Entrada/index|Caixa de Entrada]]** — Ponto de triagem de hipóteses científicas, artigos pré-print e ideias brutas.
...
* 🧬 **[[03_Conhecimento/binarizacao_expressao_genica|Conceito Atômico: Binarização de Expressão Gênica]]**
* 🧠 **[[03_Conhecimento/atencao_softmax_hopfield|Conceito Atômico: Atenção Softmax Hopfield]]**
...
Se você é um Agente de IA operando neste repositório:
1. Consulte as diretrizes detalhadas em [[AGENTS.md]].
2. Navegue pelos arquivos `index.md` de cada subpasta para localizar os nós sem ler o código inteiro.
3. Utilize os Wikilinks `[[...]]` para saltar diretamente aos conceitos atômicos de interesse.
